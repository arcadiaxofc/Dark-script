-- ============================================================
-- NEXUS v11.0 - UI ESTILO DISCORD
-- Interface moderna | Auto Farm | Kill Aura | ESP
-- ============================================================

-- ============================================================
-- DISCORD LIB (UI COMPLETA)
-- ============================================================
local DiscordLib = {}
        ...
        function ChannelHold:Channel(text)
            ...
            function ChannelContent:Button(text, callback)
                ...
                Button.MouseButton1Click:Connect(function()
                    pcall(callback)
                    Button.TextSize = 0
                    TweenService:Create(Button, TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextSize = 14}):Play()
                end)
